          ...
          <div className="landing w-full h-screen bg-black">
            <div className="navbar absolute top-0 left-0 w-full py-10 px-10 z-10">
              <div className="logo flex gap-10">
                ...
                <h3 className='text-5xl text-white leading-none -mt-[12px]'>Rockstar</h3>
              </div>
            </div>
            <div className="imagediv relative overflow-hidden h-screen w-full">
              <img src="/sky.png" alt="" className='sky scale-[1.5] -rotate-3 absolute top-0 left-0 w-full h-full object-cover'/>
              <img src="/building.png" alt="" className='building scale-[1.8] -rotate-3 absolute top-0 left-0 w-full h-full object-cover'/>
              ...
              <img src="/character.png" alt="" className='absolute character scale-2 -rotate-10 bottom-[-170%] left-1/2 -translate-x-1/2 scale-[0.7] object-cover'/>
            </div>
            <div className="bottomnav text-white absolute bottom-0 left-0 w-full py-10 px-10 bg-gradient-to-t from-black to-transparent">
              <div className="flex gap-4 items-center" >
                ...
                <img src="/xbox.webp" alt="" className='absolute h-[80px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'/>
              </div>
            </div>
          </div>
